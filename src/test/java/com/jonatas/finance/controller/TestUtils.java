...
public final class TestUtils {
    ...
    public static User createUser(UserRepository userRepository, PasswordEncoder passwordEncoder, String email) {
    ...
    public static Long createCategory(MockMvc mockMvc, String token, String name, String type) throws Exception {
        var payload = "{" +
                "\"name\": \"" + name + "\"," +
                "\"type\": \"" + type + "\"" +
                "}";
    ...
    public static Long createWallet(MockMvc mockMvc, String token, String name, boolean mainWallet) throws Exception {
        var payload = "{" +
                "\"name\": \"" + name + "\"," +
