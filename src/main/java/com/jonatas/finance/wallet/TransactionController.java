...
public class TransactionController {
  ...
  public ResponseEntity<?> add(
    ...
    if (result instanceof CreateTransactionResult.TransactionCannotBeIsInTheFuture) {
      Error<String> error =
          new Error<>("cannot_be_in_future", "Transaction cannot be in the future");
    ...
    var location =
        UriComponentsBuilder.fromPath("/{id}").buildAndExpand(transaction.getId()).toUri();
