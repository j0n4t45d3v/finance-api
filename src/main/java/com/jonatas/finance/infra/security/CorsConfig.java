...
public record CorsConfig(String mapping,
    ...
    private static void validate(List<String> allowedOrigins, boolean allowCredentials) {
        if (allowCredentials && allowedOrigins.contains("*")) {
            throw new IllegalArgumentException("security.cors.allowed-origins cannot contain '*' when security.cors.allow-credentials is true");
        }
    }
