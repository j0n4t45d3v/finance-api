...
public class BalanceBean {
  ...
  public AddTransactionPort addTransaction(
    ...
    return new AddTransactionUseCase(saveTransactionRepositoryPort, searchUserPort, updateBalanceOfMonth);
  }

  @Bean
  public SearchTransactionPort searchTransaction(
      SearchTransactionRespositoryPort searchRepositoryPort
  ) {
    return new SearchTransactionUseCase(searchRepositoryPort);
  }
